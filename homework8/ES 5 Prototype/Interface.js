...
AList.prototype = Object.create(ListInterface.prototype);
...
LList.prototype = Object.create(ListInterface.prototype);
...
SuperLList.prototype.reduce = function (callBack, initValue) {
    ...
    if(initValue !== undefined){
        while(tmpNoda.next !== this.root){
            callBackResult += callBack(initValue, tmpNoda.data, tmpNoda, this.root);
            initValue = 0;
            tmpNoda = tmpNoda.next
        }
        callBackResult += callBack(initValue, tmpNoda.data, tmpNoda, this.root);
